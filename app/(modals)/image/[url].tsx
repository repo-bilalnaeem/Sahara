    ...
    <RootSiblingParent>
      <BottomSheetModalProvider>
        ...
        <BottomSheetModal
          ...
          backgroundStyle={{ backgroundColor: '#242026' }}
          handleIndicatorStyle={{ backgroundColor: '#B8B3BA' }}>
          <View style={[styles.modalContainer, { paddingBottom: bottom, flex: 1 }]}>
              ...
              <View style={{ flex: 1 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                  ...
                  <Pressable onPress={handleCloseModalPress} style={styles.closeBtn}>
                    <Ionicons name="close-outline" size={24} color={'#B8B3BA'} />
                  </Pressable>
                </View>
            ...
            <TouchableOpacity
              style={[styles.btn, { backgroundColor: '#fff', marginTop: 16 }]}
